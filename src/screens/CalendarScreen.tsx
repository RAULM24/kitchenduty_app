...
import AlertOK from '../components/AlertComponent';
...
class Principal extends React.Component<CalendarProps, CalendarState> {
  ...
  sendInvitations = () => {
    ...
    axios.post('http://10.16.0.95:3000/mail', this.state.events)
      .then(response => {
